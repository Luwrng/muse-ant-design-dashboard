...
function PaymentResult() {
  ...
  return (
    <div
      className={`gpayresult-container ${
        isSuccess ? "gpayresult-success-bg" : "gpayresult-fail-bg"
      }`}
    >
      <div className="gpayresult-card">
        ...
        <h1
          className={`gpayresult-title ${
            isSuccess ? "gpayresult-text-success" : "gpayresult-text-fail"
          }`}
        >
        ...
        <div
          className={`gpayresult-details-section ${
            isSuccess
              ? "gpayresult-details-success-border"
              : "gpayresult-details-fail-border"
          }`}
        >
          <h2
            className={`gpayresult-details-title ${
              isSuccess ? "gpayresult-text-success" : "gpayresult-text-fail"
            }`}
          >
          ...
          <div className="gpayresult-detail-row">
            ...
            <span className="gpayresult-detail-value">
              Premium Gardener Package
            </span>
          </div>
          <div className="gpayresult-detail-row">
          ...
          <div className="gpayresult-detail-row">
            <span className="gpayresult-detail-label">
              {isSuccess ? "Purchase Date" : "Attempted Date"}
            </span>
        ...
        {!isSuccess && (
          <div className="gpayresult-error-alert">
            ...
            <p className="gpayresult-error-message">
              Your card was declined. Please check your payment details or try a
